...
<div v-if="visible"  class="absolute right-0 transition ease-out  z-10 border-stroke flex items-center rounded-md border border-l-[8px] border-l-[#00B078] bg-green-500 p-5 pl-8">
   ...
   <div class="flex w-full items-center justify-between">
      ...
      <div>
         <button class="hover:text-danger text-[#ACACB0]" @click="visible=false">
